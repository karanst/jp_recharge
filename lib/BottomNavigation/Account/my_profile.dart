...
import '../Home/Pages/transactions_page.dart';
      ...
      body: SingleChildScrollView(
        ...
        Column(
          children: [
              ...
              child: Row(
                ...
                children: [
                  CircleAvatar(
                      radius: 35,
                      backgroundImage:
                      AssetImage('assets/imgs/Layer 1753.png')),
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('${getprofile?.data?[0].username}',style: TextStyle(color: primary,fontSize: 20),),
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (c)=>EditeProfile(getprofile)));
                          },
            ...
            Padding(
              padding: const EdgeInsets.all(5.0),
              child: CustomDrawerTile(tileName: 'Transaction History ', tileIcon:Image.asset("assets/imgs/Terms & Conditions.png",scale: 1.7,),
                onTap: (){

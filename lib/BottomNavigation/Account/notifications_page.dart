...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  getNotification() async {
    ...
    var request = http.Request('POST', Uri.parse('${baseUrl}get_notifications'));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FadedSlideAnimation(
        child:
        getnotification == null || getnotification == "" ? Center(child: CircularProgressIndicator(),): ListView.builder(

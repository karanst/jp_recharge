            ...
            child: ListView(
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: EntryField(locale.adult, null, controller: controller,),
                    ),
                    SizedBox(
                      width: 15,
                    ),
                    Expanded(
                      child: EntryField(locale.child, null, controller:  controller,),
                    ),
                    SizedBox(
                      width: 15,
                    ),
                    Expanded(
                      child: EntryField(locale.infant, null, controller:  controller,),
                    ),
                  ],
                ),
                SizedBox(
